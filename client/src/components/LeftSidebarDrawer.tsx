...
import { Drawer, Box, List, Divider, ListItem, ListItemButton, ListItemIcon, ListItemText, Typography } from '@mui/material';
        ...
        {[
          ...
          <ListItem key={item.text} disablePadding>
            <ListItemButton
              ...
              sx={{
                backgroundColor: selectedIndex === index ? '#304252' : 'transparent',
                '&:hover': {
                  backgroundColor: '#304252', 
                },
              }}
            >
              <ListItemIcon sx={{ color: selectedIndex === index ? 'white' : 'blue' }}>
        ...
        {[
          ...
          <ListItem key={item.text} disablePadding>
            <ListItemButton
              ...
              onClick={() => handleListItemClick(index + 5, item.path)} 
              sx={{
                backgroundColor: selectedIndex === index + 5 ? '#616161' : 'transparent',
                '&:hover': {
                  backgroundColor: '#616161',
                },
              }}
            >
              <ListItemIcon sx={{ color: selectedIndex === index + 5 ? 'white' : 'blue' }}>
